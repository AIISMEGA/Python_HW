...
my_printer_1 = Printer('Hp', 'XS5050', 2700, ['red', 'blue', 'green'])
my_printer_2 = Printer('Canon', 'TS304', 1300, ['black'])

my_notebook_1 = Notebook("Lenovo", "ThinkPad X1", 1600, 16, "Windows")
my_notebook_2 = Notebook("Mac", "MacBookAir", 2300, 56, "MacOS")

Storage.storage_to(unit_type="Printer", unit_name="Hp", unit_model="XS5050", unit_count=2000)
Storage.get_all_equipment()

Storage.storage_to(unit_type='Notebook', unit_name='Lenovo', unit_model='ThinkPad X1', unit_count=2300)
Storage.get_all_equipment()
